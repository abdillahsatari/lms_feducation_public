		...
		<div class="card forgot-box">
			<div class="card-body">
				<div class="p-4 rounded  border">
					<form method="POST" action="<?= base_url('member/password/reset')?>">
						...
						<div class="d-grid gap-2">
							<button type="submit" class="btn btn-light btn-lg">Kirim</button> 
							<a href="<?= base_url('member/login')?>" class="btn btn-light btn-lg">
