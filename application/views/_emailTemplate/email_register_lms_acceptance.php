							...
							<tr>
								<td align="left" valign="top">
									<font face="'Source Sans Pro', sans-serif" color="#1a1a1a" style="font-size: 52px; line-height: 60px; font-weight: 300; letter-spacing: -1.5px;">
										<span style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif;color: #1a1a1a;font-size: 36px;line-height: 60px;font-weight: 300;letter-spacing: -1.5px;">Pembayaran Aktivasi Akun LMS Berhasil</span>
									</font>
                                 ...
                                 <span style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #585858; font-size: 18px; line-height: 32px;">
									 ...
									 <span style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif;color: #1a1a1a;font-size: 25px;line-height: 60px;font-weight: 300;letter-spacing: -1.5px;">Wohoo!</span>
									 <br>
									 Dear <?= $user['memberFullName']; ?>, Pembayaran kamu pada Program E-Course / LMS Feducation sudah selesai.<br>
									 Terima kasih telah menyelesaikan proses pendaftaran. Sekarang kamu sudah bisa menikmati berbagai program kursus yang ada di LMS Feducation Id dengan akses berikut:
									 <br>
									 <hr/>
                                    <table id="credentials">
									 ...
									 <!-- Yuk gabung di komunitas <?= $user['courseType']; ?> se-Indonesia untuk mengetahui jadwal kelas dan info menarik lainnya melalui link di bawah ini:
									 <br><br>
									 <table class="mob_btn" cellpadding="0" cellspacing="0" border="0" style="background: #27cbcc; border-radius: 4px;">
                                       <tr>
                                          <td align="center" valign="top">
                                             <a href="<?= $user['courseChannel']?>" target="_blank" style="display: block; border: 1px solid #2769cc; border-radius: 4px; padding: 12px 23px; font-family: 'Source Sans Pro', Arial, Verdana, Tahoma, Geneva, sans-serif; color: #ffffff; font-size: 20px; line-height: 30px; text-decoration: none; white-space: nowrap; font-weight: 600;">
                                                <font face="'Source Sans Pro', sans-serif" color="#ffffff" style="font-size: 20px; line-height: 30px; text-decoration: none; white-space: nowrap; font-weight: 600;">
                                                   <span style="font-family: 'Source Sans Pro', Arial, Verdana, Tahoma, Geneva, sans-serif; color: #ffffff; font-size: 20px; line-height: 30px; text-decoration: none; white-space: nowrap; font-weight: 600;">Group Kelas Telegram</span>
                                                </font>
                                             </a>
                                    ...
                                    <br>
                                    Mau nambah skill sekalian cari cuan ? kamu bisa gunakan kode referal di bawah untuk mereferensikan kelas feducation dan mendapatkan komisi sebesar 25% dari biaya kelas yang teman kamu ikuti looh.
									Yuk ajakin lebih banyak teman kamu ikut kelas di Program E-Course Feducation.
								 	<br>
									<hr/>
									 Mohon berhati-hati terhadap modus penipuan yang mengatasnamakan feducation. Info resmi hanya disalurkan melalui email <span style="font-weight: 300">support@feducation.id</span> dan nomor
									 <span style="font-weight: 300">089-505-030-221 / 0821-2311-1325</span>
                                 </span>
									</font>
											...
											<td align="center" valign="top">
												<table cellpadding="0" cellspacing="0" border="0" width="78%" style="min-width: 300px;">
													<tr>
														...
														<td align="center" valign="top" width="23%">
															<a href="https://feducation.id" target="_blank" style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #1a1a1a; font-size: 14px; line-height: 20px; text-decoration: none; white-space: nowrap; font-weight: bold;">
																<font face="'Source Sans Pro', sans-serif" color="#1a1a1a" style="font-size: 14px; line-height: 20px; text-decoration: none; white-space: nowrap; font-weight: bold;">
