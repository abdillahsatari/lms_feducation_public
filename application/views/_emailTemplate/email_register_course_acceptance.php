							...
							<tr>
								<td align="left" valign="top">
									<font face="'Source Sans Pro', sans-serif" color="#1a1a1a" style="font-size: 52px; line-height: 60px; font-weight: 300; letter-spacing: -1.5px;">
										<span style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif;color: #1a1a1a;font-size: 36px;line-height: 60px;font-weight: 300;letter-spacing: -1.5px;">Konfirmasi Pembayaran</span>
									</font>
                                 ...
                                 <span style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #585858; font-size: 18px; line-height: 32px;">
									 ...
									 <br>
									 Pembayaran kamu pada kelas <?= $user['courseHeadline']; ?> sudah selesai, terima kasih <?= $user['memberFullName']; ?>, sekarang kamu sudah selangkah lebih maju untuk meningkatkan skill kamu.
                                    ...
                                    <br>
                                    Mau nambah skill sekalian cari cuan ? kamu bisa gunakan kode referal di bawah untuk mereferensikan kelas feducation dan mendapatkan komisi sebesar 20% dari biaya kelas yang teman kamu ikuti.
								 	<br>
									<hr/>
