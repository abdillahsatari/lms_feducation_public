							...
							<tr>
								<td align="left" valign="top">
									<font face="'Source Sans Pro', sans-serif" color="#1a1a1a" style="font-size: 52px; line-height: 60px; font-weight: 300; letter-spacing: -1.5px;">
										<span style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif;color: #1a1a1a;font-size: 36px;line-height: 60px;font-weight: 300;letter-spacing: -1.5px;">Rincian Pendaftaran</span>
									</font>
                                 ...
                                 <span style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #585858; font-size: 18px; line-height: 32px;">
                                    ...
                                    Dear <?= $user['memberFullName']; ?>. Terimakasih telah mendaftar dalam program kursus <?= $user['courseCategory']?> Feducation Id. Anda akan segera dihubungi oleh tim kami untuk info jadwal kelas yang anda ambil,
									 setelah pendaftaran anda di approve oleh tim kami.

                                    <br>
                                    Berikut adalah rincian pendaftaran kelas trading yang anda daftarkan:
                                    <br>
								 	<br>
									<hr/>
                                    ...
                                    <table id="credentials">
                                       <tr>
										...
										<tr>
                                          ...
                                          <td>:</td>
                                          <td><?= $user['paymentGateway'] ?></td>
                                       </tr>
                                       <tr>
                                          <td>No. Rekening</td>
                                          <td>:</td>
                                          <td><?= $user['nomorRekening'] ?></td>
                                       </tr>
										<tr>
                                          <td>Atas Nama</td>
                                          <td>:</td>
                                          <td><?= $user['pemilikAkunBank'] ?></td>
                                       </tr>
                                    </table>
                                 </span>
									</font>
