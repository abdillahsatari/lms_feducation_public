							...
							<tr>
								<td align="left" valign="top">
                                 ...
                                 <span style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #585858; font-size: 18px; line-height: 32px;">
                                    ...
                                    Dear <?= $user['memberFullName']; ?>, sebelum Anda menggunakan layanan kabinet Kursus Feducation.id, silahkan verifikasi akun email Anda.

                                    <div style="height: 33px; line-height: 33px; font-size: 31px;">&nbsp;</div>
                                    <table class="mob_btn" cellpadding="0" cellspacing="0" border="0" style="background: #27cbcc; border-radius: 4px;">
                                       <tr>
                                          <td align="center" valign="top">
                                             <a href="<?= site_url() ?>member/verify?email=<?= $user['memberEmail']; ?>&token=<?= urlencode($user['memberToken']); ?>&password=<?= urlencode($user['memberPassword']); ?>" target="_blank" style="display: block; border: 1px solid #27cbcc; border-radius: 4px; padding: 12px 23px; font-family: 'Source Sans Pro', Arial, Verdana, Tahoma, Geneva, sans-serif; color: #ffffff; font-size: 20px; line-height: 30px; text-decoration: none; white-space: nowrap; font-weight: 600;">
                                    ...
                                    <br>
                                    Setelah berhasil verifikasi, Anda dapat login menggunakan email dan password pada saat anda mendaftar atau dengan kredensial berikut:
                                    <br>
