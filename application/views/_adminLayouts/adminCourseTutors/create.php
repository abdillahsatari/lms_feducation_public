<div class="page-content">
	...
	<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
		<div class="breadcrumb-title pe-3">Add Tutors</div>
		<div class="ps-3">
	...
	<div class="container mb-5">
		<div class="main-body">
			<div class="card">
				<form role="form" action="<?= base_url('admin/course/tutor/save')?>" method="POST" class="js-form_add-course_tutor">
								...
								<div class="card">
									<div class="card-body">
										...
										<div class="d-flex flex-column align-items-center text-center">
											<img src="<?= base_url('assets/resources/images/tutors/default_intern_ava.png')?>"
												 class="card-img image-preview" alt="Feducation tutor">
											<div class="mt-3">
										...
										<div class="row">
											<div class="col-6">
												<div class="mb-3">
													...
													<input type="text" name="tutor_name" placeholder="Nama" class="form-control" data-rule-required="true" data-msg="Nama Tutor Tidak Boleh Kosong">
													<small class="text-danger"><?= form_error('tutor_name')?></small>
												</div>
												<div class="mb-3">
													<label class="mb-1">No. Hp</label>
													<input type="number" name="tutor_phone_number" placeholder="No. Hp" class="form-control" data-rule-required="true" data-msg="No.Hp Tutor Tidak Boleh Kosong">
												...
												<div class="mb-3">
													...
													<input type="hidden" name="tutor_image" id="tutor_image">
												</div>
											</div>
											<div class="col-6">
												<div class="mb-3">
													<label class="mb-1">Email</label>
													<input type="email" name="tutor_email" placeholder="Email" class="form-control" 
															data-rule-required="true" data-msg="Email Tutor Tidak Boleh Kosong" data-msg-email="Format Email salah">
													<small class="text-danger"><?= form_error('tutor_email')?></small>
												</div>
												<div class="mb-3">
													<label class="mb-1">Achievement Highlight</label>
													<input type="text" name="tutor_achievement" placeholder="Achievement" class="form-control" data-rule-required="true" data-msg="Achievement Tutor Tidak Boleh Kosong">
										...
										<div class="row">
											<div class="col-12">
												<div class="mb-3">
													...
													<textarea id="tinyMceTextArea" name="tutor_overview"></textarea>
												</div>
											</div>
										</div>
									</div>
											...
											<div class="row">
												<div class="col-4">
													<div class="mb-3">
														...
														<input type="text" name="tutor_facebook" placeholder="url Facebook" class="form-control" data-rule-required="true" data-msg="url Facebook Tidak Boleh Kosong">
												...
												<div class="col-4">
													<div class="mb-3">
														...
														<input type="text" name="tutor_instagram" placeholder="url Instagram" class="form-control" data-rule-required="true" data-msg="url Instagram Tidak Boleh Kosong">
												...
												<div class="col-4">
													<div class="mb-3">
														...
														<input type="text" name="tutor_linkedin" placeholder="url Linkedin" class="form-control" data-rule-required="true" data-msg="url Linkedin Tidak Boleh Kosong">
