<div class="page-content">
		...
		<div class="ps-3">
			<nav aria-label="breadcrumb">
				<ol class="breadcrumb mb-0 p-0">
					...
					<li class="breadcrumb-item active" aria-current="page">Edit Articel</li>
				</ol>
			</nav>
		</div>
	</div>
	...
	<div class="card">
		<div class="card-body p-4">
			<h5 class="card-title">Articel</h5>
			<hr>
			<div class="form-body mt-4">
				<div class="row">
					<div class="col-lg-12">
						<form role="form" method="post" class="js_admin-article"
							  action="<?= base_url('admin/article/update')?>">
							<input type="hidden" name="<?= $csrfName ?>" value="<?= $csrfToken ?>">
							<input type="hidden" name="article_id" value="<?= $dataArticle->id ?>">
							<div class="row">
								<div class="col-4">
									<div class="form-group">
										<label for="exampleInputEmail1">Article Headline</label>
										<input type="text" class="form-control js-article-create-headline" id="title" name="article_headline" value="<?= $dataArticle->article_headline ?>" placeholder="Enter articel headline"
								...
								<div class="col-4">
									<div class="form-group">
										...
										<input name="article_slug" id="articleSlug" type="text" class="form-control js-article-create-slug" value="<?= $dataArticle->article_slug ?>" placeholder="Slug"
									...
									<div class="form-group">
										...
										<select class="form-control single-select js-input-with-plugin" name="article_category_id"
											...
											<?php foreach($dataArticleCat as $cat):?>
												<option value="<?= $cat->id?>" <?= $cat->id == $dataArticle->article_category_id ? "selected" : ""?>><?= $cat->article_category_headline?></option>
											<?php endforeach;?>
										</select>
								...
								<div class="col-lg-6">
									<div class="form-group">
										...
										<textarea name="article_meta_description" id="article_meta_description" type="text" class="form-control" placeholder="Meta Description" rows="4"
												  data-rule-required="true" data-msg="Kolom Meta Description Tidak Boleh Kosong"><?= $dataArticle->article_meta_description ?></textarea>
										<small class="text-danger"><?= form_error('article_meta_description')?></small>
									</div>
									<br>
									<div class="form-group">
										<label for="article_keyword">Keyword</label>
										<input name="article_keyword" id="article_keyword" type="text" class="form-control js-input-with-plugin" value="<?= $dataArticle->article_keyword ?>" placeholder="Keyword"
									...
									<div class="form-group">
										...
										<input name="article_author" id="article_author" type="text" class="form-control" placeholder="Author" value="<?= $dataArticle->article_author ?>"
								...
								<div class="col-lg-6">
									<div class="form-group">
										<div class="mb-3">
											...
											<img src="<?= $dataArticle->article_thumbnail ? base_url('assets/resources/images/articles/thumbnails/').$dataArticle->article_thumbnail : "https://via.placeholder.com/370x282.png?text=Preview" ?>" alt="Feducation Article Thumbnail"
											...
											<input type="hidden" name="article_thumbnail" value="<?= $dataArticle->article_thumbnail ?>" id="article_thumbnail">
										</div>
										<br/>
									</div>
								</div>
							...
							<div class="col-12">
								<div class="form-group">
									<div class="mb-3">
										...
										<img src="<?= $dataArticle->article_cover ? base_url('assets/resources/images/articles/covers/').$dataArticle->article_cover : "https://via.placeholder.com/770x463.png?text=Preview" ?>" alt="Feducation Article Cover"
										...
										<input type="hidden" name="article_cover" value="<?= $dataArticle->article_cover ?>" id="article_cover">
									</div>
								</div>
								<br/>
							</div>
							...
							<div class="col-12">
								<div class="form-group">
									...
									<textarea name="article_content" id="js-ckeditor"><?= $dataArticle->article_content ?></textarea>
